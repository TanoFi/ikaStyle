...
class LoadoutRecyclerViewAdapter(private val storeViewModel: StoreViewModel) : RecyclerView.Adapter<LoadoutRecyclerViewAdapter.ViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.imageViewClothing.setImageResource(Util.getHeadGearResourceId(loadout.clothingGearId))
        ...
        holder.binding.imageViewShoes.setImageResource(Util.getHeadGearResourceId(loadout.shoesGearId))
