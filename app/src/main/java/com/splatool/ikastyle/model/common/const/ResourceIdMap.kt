 ...
 */
object ResourceIdMap {
    // ギアパワー画像
    val gearPowerResourceIdMap: Map<Int, Int> = Collections.unmodifiableMap(
        object : HashMap<Int, Int>() {
            init {
                put(0, R.drawable.gearpower_not_set) //未設定
                put(1, R.drawable.gearpower_ink_saver_main) //メイン効率
                put(2, R.drawable.gearpower_ink_saver_sub) //サブ効率
                put(3, R.drawable.gearpower_ink_recovery_up) //インク回復
                put(4, R.drawable.gearpower_run_speed_up) //ヒト速
                put(5, R.drawable.gearpower_swim_speed_up) //イカ速
                put(6, R.drawable.gearpower_special_charge_up) //スペ増
                put(7, R.drawable.gearpower_special_saver) //スペ減
                put(8, R.drawable.gearpower_special_power_up) //スペ強
                put(9, R.drawable.gearpower_quick_respawn) //復活短縮
                put(10, R.drawable.gearpower_quick_super_jump) //ジャンプ短縮
                put(11, R.drawable.gearpower_sub_power_up) //サブ性能
                put(12, R.drawable.gearpower_ink_resistance_up) //安全靴
                put(13, R.drawable.gearpower_bomb_defence_up_dx) //爆風軽減
                put(14, R.drawable.gearpower_main_power_up) //メイン性能
                put(100, R.drawable.gearpower_opening_gambit) //スタートダッシュ
                put(101, R.drawable.gearpower_last_ditch_effort) //ラストスパート
                put(102, R.drawable.gearpower_tenacity) //逆境
                put(103, R.drawable.gearpower_comeback) //カムバック
                put(200, R.drawable.gearpower_ninja_squid) //イカ忍者
                put(201, R.drawable.gearpower_haunt) //リベンジ
                put(202, R.drawable.gearpower_thermal_ink) //サーマルインク
                put(203, R.drawable.gearpower_respawn_punisher) //ペナアップ
                put(204, R.drawable.gearpower_ability_doubler) //サブギア倍化
                put(300, R.drawable.gearpower_stealth_jump) //ステルスジャンプ
                put(301, R.drawable.gearpower_object_shredder) //対物攻撃力アップ
                put(302, R.drawable.gearpower_drop_roller) //受け身術
            }
        }
    )

    // アタマのギア画像
    val headGearResourceIdMap: Map<Int, Int> = Collections.unmodifiableMap(
        object : HashMap<Int, Int>() {
            init {
    ...
    // フクのギア画像
    val clothingGearResourceIdMap : Map<Int, Int> = Collections.unmodifiableMap(
        object : HashMap<Int, Int>() {
            init {
    ...
    // クツのギア画像
    val shoesGearResourceIdMap :Map<Int, Int> = Collections.unmodifiableMap(
        object : HashMap<Int, Int>() {
            init {
    ...
    // ブキ画像
    val weaponResourceIdMap : Map<Int, Int> = Collections.unmodifiableMap(
        object : HashMap<Int, Int>() {
            init {
